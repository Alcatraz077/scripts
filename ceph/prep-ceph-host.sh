#/bin/bash
### This script preps a box to be used as a ceph host
...
### Adds ceph01 public SSH Key
echo "KEY-GOES-HERE" >> ~/.ssh/authorized_keys
...
echo "### Ceph Host Prep Has Finished, add node via 'ceph orch host add (hostname) (IP)'###" 
