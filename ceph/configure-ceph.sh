...
echo "172.16.168.6    ceph01.alcatraz.network    ceph01" >> /etc/hosts
echo "172.16.168.8    ceph02.alcatraz.network    ceph02" >> /etc/hosts
echo "172.16.168.10   ceph03.alcatraz.network    ceph03" >> /etc/hosts
echo "172.16.168.12   ceph04.alcatraz.network    ceph04" >> /etc/hosts
echo "172.16.168.14   ceph05.alcatraz.network    ceph05" >> /etc/hosts
echo "172.16.168.16   ceph06.alcatraz.network    ceph06" >> /etc/hosts
